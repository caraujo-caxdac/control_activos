$PBExportHeader$w_imprime_activo_fisico_x_tipo_inventario.srw
$PBExportComments$Ventana para la Impresión del Activo Fisico
forward
global type w_imprime_activo_fisico_x_tipo_inventario from window
end type
type cb_filtrar from commandbutton within w_imprime_activo_fisico_x_tipo_inventario
end type
type cb_ordenar from commandbutton within w_imprime_activo_fisico_x_tipo_inventario
end type
type cb_limpiar from commandbutton within w_imprime_activo_fisico_x_tipo_inventario
end type
type cb_exportar from commandbutton within w_imprime_activo_fisico_x_tipo_inventario
end type
type mle_1 from multilineedit within w_imprime_activo_fisico_x_tipo_inventario
end type
type st_3 from statictext within w_imprime_activo_fisico_x_tipo_inventario
end type
type st_2 from statictext within w_imprime_activo_fisico_x_tipo_inventario
end type
type pb_2 from picturebutton within w_imprime_activo_fisico_x_tipo_inventario
end type
type pb_1 from picturebutton within w_imprime_activo_fisico_x_tipo_inventario
end type
type st_1 from statictext within w_imprime_activo_fisico_x_tipo_inventario
end type
type dw_1 from datawindow within w_imprime_activo_fisico_x_tipo_inventario
end type
type rr_2 from roundrectangle within w_imprime_activo_fisico_x_tipo_inventario
end type
type rr_1 from roundrectangle within w_imprime_activo_fisico_x_tipo_inventario
end type
end forward
...
string title = "Imprimir Inventario Físico..."
...
global w_imprime_activo_fisico_x_tipo_inventario w_imprime_activo_fisico_x_tipo_inventario
...
on w_imprime_activo_fisico_x_tipo_inventario.create
...
on w_imprime_activo_fisico_x_tipo_inventario.destroy
...
nombre_reporte		= "Reporte Inventario Fisico de Activos"
nombre_exportar	= "Inventario Fisico de Activos"
...
event clicked;close(w_imprime_activo_fisico_x_tipo_inventario)
end event
...
boolean enabled = false
string text = "Impresión Inventario Físico por Tipo de Inventario"
alignment alignment = center!
boolean focusrectangle = false
end type
...
integer taborder = 10
boolean titlebar = true
string title = "Reporte Inventario Físico..."
string dataobject = "dw_impresion_activo_fisico_x_tipo_inventario"
boolean minbox = true
boolean maxbox = true
