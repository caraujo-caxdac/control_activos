$PBExportHeader$w_imprime_activo_fisico_x_responsable.srw
$PBExportComments$Ventana para la Impresión del Activo Fisico
forward
global type w_imprime_activo_fisico_x_responsable from window
end type
type cb_filtrar from commandbutton within w_imprime_activo_fisico_x_responsable
end type
type cb_ordenar from commandbutton within w_imprime_activo_fisico_x_responsable
end type
type cb_limpiar from commandbutton within w_imprime_activo_fisico_x_responsable
end type
type cb_exportar from commandbutton within w_imprime_activo_fisico_x_responsable
end type
type mle_1 from multilineedit within w_imprime_activo_fisico_x_responsable
end type
type st_3 from statictext within w_imprime_activo_fisico_x_responsable
end type
type st_2 from statictext within w_imprime_activo_fisico_x_responsable
end type
type pb_2 from picturebutton within w_imprime_activo_fisico_x_responsable
end type
type pb_1 from picturebutton within w_imprime_activo_fisico_x_responsable
end type
type st_1 from statictext within w_imprime_activo_fisico_x_responsable
end type
type dw_1 from datawindow within w_imprime_activo_fisico_x_responsable
end type
type rr_2 from roundrectangle within w_imprime_activo_fisico_x_responsable
end type
type rr_1 from roundrectangle within w_imprime_activo_fisico_x_responsable
end type
end forward
...
global w_imprime_activo_fisico_x_responsable w_imprime_activo_fisico_x_responsable
...
on w_imprime_activo_fisico_x_responsable.create
...
on w_imprime_activo_fisico_x_responsable.destroy
...
event clicked;close(w_imprime_activo_fisico_x_responsable)
end event
...
boolean enabled = false
string text = "Impresión Inventario Físico por Responsable"
alignment alignment = center!
boolean focusrectangle = false
end type
...
string dataobject = "dw_impresion_activo_fisico_x_responsable"
boolean minbox = true
boolean maxbox = true
