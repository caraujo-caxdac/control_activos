$PBExportHeader$w_imprime_activo_fisico_x_resp_x_entrega.srw
$PBExportComments$Ventana para la Impresión del Activo Fisico
forward
global type w_imprime_activo_fisico_x_resp_x_entrega from window
end type
type cb_filtrar from commandbutton within w_imprime_activo_fisico_x_resp_x_entrega
end type
type cb_ordenar from commandbutton within w_imprime_activo_fisico_x_resp_x_entrega
end type
type cb_limpiar from commandbutton within w_imprime_activo_fisico_x_resp_x_entrega
end type
type cb_exportar from commandbutton within w_imprime_activo_fisico_x_resp_x_entrega
end type
type mle_1 from multilineedit within w_imprime_activo_fisico_x_resp_x_entrega
end type
type st_3 from statictext within w_imprime_activo_fisico_x_resp_x_entrega
end type
type st_2 from statictext within w_imprime_activo_fisico_x_resp_x_entrega
end type
type pb_2 from picturebutton within w_imprime_activo_fisico_x_resp_x_entrega
end type
type pb_1 from picturebutton within w_imprime_activo_fisico_x_resp_x_entrega
end type
type st_1 from statictext within w_imprime_activo_fisico_x_resp_x_entrega
end type
type dw_1 from datawindow within w_imprime_activo_fisico_x_resp_x_entrega
end type
type rr_2 from roundrectangle within w_imprime_activo_fisico_x_resp_x_entrega
end type
type rr_1 from roundrectangle within w_imprime_activo_fisico_x_resp_x_entrega
end type
end forward
...
global w_imprime_activo_fisico_x_resp_x_entrega w_imprime_activo_fisico_x_resp_x_entrega
...
on w_imprime_activo_fisico_x_resp_x_entrega.create
...
on w_imprime_activo_fisico_x_resp_x_entrega.destroy
...
dw_hija.SetSort("descripcion_tercero A, descripcion_tipo_inventario A, descripcion_clase_activo A, descripcion_corta A, placa_inventario A")
dw_hija.Sort()
dw_hija.SetRedraw(true)
dw_hija.GroupCalc()
end event
...
event clicked;close(w_imprime_activo_fisico_x_resp_x_entrega)
end event
...
boolean enabled = false
string text = "Impresión Inventario Físico por Responsable para Entrega"
alignment alignment = center!
boolean focusrectangle = false
end type
...
string dataobject = "dw_impresion_activo_fisico_x_resp_x_entrega"
boolean minbox = true
boolean maxbox = true
