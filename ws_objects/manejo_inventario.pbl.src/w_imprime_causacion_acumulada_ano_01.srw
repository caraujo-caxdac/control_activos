$PBExportHeader$w_imprime_causacion_acumulada_ano_01.srw
$PBExportComments$Ventana para la Impresión de la Causación Acumulada por Año
forward
global type w_imprime_causacion_acumulada_ano_01 from window
end type
type cb_filtrar from commandbutton within w_imprime_causacion_acumulada_ano_01
end type
type cb_ordenar from commandbutton within w_imprime_causacion_acumulada_ano_01
end type
type cb_limpiar from commandbutton within w_imprime_causacion_acumulada_ano_01
end type
type cb_exportar from commandbutton within w_imprime_causacion_acumulada_ano_01
end type
type mle_1 from multilineedit within w_imprime_causacion_acumulada_ano_01
end type
type st_3 from statictext within w_imprime_causacion_acumulada_ano_01
end type
type st_2 from statictext within w_imprime_causacion_acumulada_ano_01
end type
type pb_2 from picturebutton within w_imprime_causacion_acumulada_ano_01
end type
type pb_1 from picturebutton within w_imprime_causacion_acumulada_ano_01
end type
type st_1 from statictext within w_imprime_causacion_acumulada_ano_01
end type
type dw_1 from datawindow within w_imprime_causacion_acumulada_ano_01
end type
type rr_2 from roundrectangle within w_imprime_causacion_acumulada_ano_01
end type
type rr_1 from roundrectangle within w_imprime_causacion_acumulada_ano_01
end type
end forward
...
string title = "Imprimir Depreciación Acumulada por Año..."
...
global w_imprime_causacion_acumulada_ano_01 w_imprime_causacion_acumulada_ano_01
...
on w_imprime_causacion_acumulada_ano_01.create
...
on w_imprime_causacion_acumulada_ano_01.destroy
...
event open;st_control_activos lst_control_activos

lst_control_activos = Message.PowerObjectParm

ano_periodo				= lst_control_activos.ano_cierre
mes_cierre_inicial	= lst_control_activos.mes_cierre
nombre_mes_inicial	= lst_control_activos.nombre_mes
mes_cierre_final		= lst_control_activos.mes_cierre_2
nombre_mes_final		= lst_control_activos.nombre_mes_2

dw_1.settransobject(sqlca)
dw_1.retrieve(ano_periodo)
...
dw_hija.Retrieve(ano_periodo)

w_imprime_causacion_acumulada_ano_01.Title = "Imprimir Depreciación Acumulada por Año -> "+String(ano_periodo,"###,###")+"..."

nombre_reporte		= "Reporte Depreciación Acumulada por Año"
nombre_exportar	= "Depreciacion Acumulada Año "+String(ano_periodo)
...
dw_1.Object.t_periodo.Text		= "Año "+String(ano_periodo,"###,###")+&
											" Periodo "+nombre_mes_inicial+" a "+nombre_mes_final
...
dw_hija.SetSort("codigo_tipo_inventario A, descripcion_clase_activo A, descripcion_marca A, descripcion_corta A, placa_inventario A")
dw_hija.Sort()
dw_hija.SetRedraw(true)
dw_hija.GroupCalc()
end event
...
event clicked;close(w_imprime_causacion_acumulada_ano_01)
end event
...
boolean enabled = false
string text = "Impresión Depreciación Acumulada por Año"
alignment alignment = center!
boolean focusrectangle = false
end type
...
integer taborder = 10
boolean titlebar = true
string title = "ReporteDepreciación Acumulada por Año..."
string dataobject = "dw_imprime_causacion_acumulada_ano_01"
boolean minbox = true
boolean maxbox = true
