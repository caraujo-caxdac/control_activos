$PBExportHeader$w_imprime_causacion_mensual_activo.srw
$PBExportComments$Ventana para la Impresión de la Causación Mensual de Activo Fisico
forward
global type w_imprime_causacion_mensual_activo from window
end type
type cb_filtrar from commandbutton within w_imprime_causacion_mensual_activo
end type
type cb_ordenar from commandbutton within w_imprime_causacion_mensual_activo
end type
type cb_limpiar from commandbutton within w_imprime_causacion_mensual_activo
end type
type cb_exportar from commandbutton within w_imprime_causacion_mensual_activo
end type
type mle_1 from multilineedit within w_imprime_causacion_mensual_activo
end type
type st_3 from statictext within w_imprime_causacion_mensual_activo
end type
type st_2 from statictext within w_imprime_causacion_mensual_activo
end type
type pb_2 from picturebutton within w_imprime_causacion_mensual_activo
end type
type pb_1 from picturebutton within w_imprime_causacion_mensual_activo
end type
type st_1 from statictext within w_imprime_causacion_mensual_activo
end type
type dw_1 from datawindow within w_imprime_causacion_mensual_activo
end type
type rr_2 from roundrectangle within w_imprime_causacion_mensual_activo
end type
type rr_1 from roundrectangle within w_imprime_causacion_mensual_activo
end type
end forward
...
string title = "Imprimir Depreciación Mensual..."
...
global w_imprime_causacion_mensual_activo w_imprime_causacion_mensual_activo
...
on w_imprime_causacion_mensual_activo.create
...
on w_imprime_causacion_mensual_activo.destroy
...
ano_cierre	= lst_control_activos.ano_cierre
mes_cierre	= lst_control_activos.mes_cierre
nombre_mes	= lst_control_activos.nombre_mes
...
dw_hija.Retrieve(ano_cierre,mes_cierre)

nombre_reporte		= "Reporte Causación Mensual Inventario"
nombre_exportar	= "Causacion Mensual Inventario"
...
dw_1.Object.t_periodo.Text		= "Perido "+nombre_mes+"/"+String(ano_cierre,"###,###")
...
CHOOSE CASE extension_named
	CASE "XLS"
		value_as = dw_hija.SaveAs(nombre_archivo,Excel8!,TRUE)
	CASE "DBF"
...
event clicked;close(w_imprime_causacion_mensual_activo)
end event
...
boolean enabled = false
string text = "Impresión Cálculo Mensual Depreciación"
alignment alignment = center!
boolean focusrectangle = false
end type
...
integer taborder = 10
boolean titlebar = true
string title = "Reporte Depreciación Mensual..."
string dataobject = "dw_impresion_causacion_mensual"
boolean minbox = true
boolean maxbox = true
