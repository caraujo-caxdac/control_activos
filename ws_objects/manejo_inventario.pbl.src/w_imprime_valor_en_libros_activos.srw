$PBExportHeader$w_imprime_valor_en_libros_activos.srw
$PBExportComments$Ventana para la Impresión del Valor en Libro de los Activos
forward
global type w_imprime_valor_en_libros_activos from window
end type
type cb_filtrar from commandbutton within w_imprime_valor_en_libros_activos
end type
type cb_ordenar from commandbutton within w_imprime_valor_en_libros_activos
end type
type cb_limpiar from commandbutton within w_imprime_valor_en_libros_activos
end type
type cb_exportar from commandbutton within w_imprime_valor_en_libros_activos
end type
type mle_1 from multilineedit within w_imprime_valor_en_libros_activos
end type
type st_3 from statictext within w_imprime_valor_en_libros_activos
end type
type st_2 from statictext within w_imprime_valor_en_libros_activos
end type
type pb_2 from picturebutton within w_imprime_valor_en_libros_activos
end type
type pb_1 from picturebutton within w_imprime_valor_en_libros_activos
end type
type st_1 from statictext within w_imprime_valor_en_libros_activos
end type
type dw_1 from datawindow within w_imprime_valor_en_libros_activos
end type
type rr_2 from roundrectangle within w_imprime_valor_en_libros_activos
end type
type rr_1 from roundrectangle within w_imprime_valor_en_libros_activos
end type
end forward
...
global w_imprime_valor_en_libros_activos w_imprime_valor_en_libros_activos
...
on w_imprime_valor_en_libros_activos.create
...
on w_imprime_valor_en_libros_activos.destroy
...
dw_1.retrieve(ano_periodo, mes_cierre_inicial)
...
dw_hija.Retrieve(ano_periodo,mes_cierre_inicial)

w_imprime_valor_en_libros_activos.Title = "Imprimir Valor en Libros Periodo -> "+String(ano_periodo,"###,###")+"/"+nombre_mes_inicial+"..."

nombre_reporte		= "Reporte Valor en Libro de Activos"
nombre_exportar	= "Valor en Libro de los Activos "+String(ano_periodo)+"_"+String(mes_cierre_inicial,"00")
...
dw_1.Object.t_periodo.Text		= "Con Corte a "+String(ano_periodo,"###,###")+&
											"/"+nombre_mes_inicial
...
event clicked;close(w_imprime_valor_en_libros_activos)
end event
...
long backcolor = 16777215
boolean enabled = false
string text = "Impresión Valor en Libro de Activos"
alignment alignment = center!
boolean focusrectangle = false
end type
...
string dataobject = "dw_imprime_valor_en_libros_activos"
boolean minbox = true
boolean maxbox = true
