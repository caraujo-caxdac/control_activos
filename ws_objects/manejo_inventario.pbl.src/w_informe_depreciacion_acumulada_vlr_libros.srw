$PBExportHeader$w_informe_depreciacion_acumulada_vlr_libros.srw
$PBExportComments$Ventana para la Impresión de la Depreciación Acumulada a un mes
forward
global type w_informe_depreciacion_acumulada_vlr_libros from window
end type
type st_6 from statictext within w_informe_depreciacion_acumulada_vlr_libros
end type
type st_5 from statictext within w_informe_depreciacion_acumulada_vlr_libros
end type
type st_4 from statictext within w_informe_depreciacion_acumulada_vlr_libros
end type
type limpiar from picturebutton within w_informe_depreciacion_acumulada_vlr_libros
end type
type mle_1 from multilineedit within w_informe_depreciacion_acumulada_vlr_libros
end type
type salir from picturebutton within w_informe_depreciacion_acumulada_vlr_libros
end type
type imprimir from picturebutton within w_informe_depreciacion_acumulada_vlr_libros
end type
type st_3 from statictext within w_informe_depreciacion_acumulada_vlr_libros
end type
type ano from editmask within w_informe_depreciacion_acumulada_vlr_libros
end type
type st_12 from statictext within w_informe_depreciacion_acumulada_vlr_libros
end type
type mes_inicial from dropdownlistbox within w_informe_depreciacion_acumulada_vlr_libros
end type
type st_1 from statictext within w_informe_depreciacion_acumulada_vlr_libros
end type
type gb_1 from groupbox within w_informe_depreciacion_acumulada_vlr_libros
end type
type rr_3 from roundrectangle within w_informe_depreciacion_acumulada_vlr_libros
end type
type rr_1 from roundrectangle within w_informe_depreciacion_acumulada_vlr_libros
end type
end forward
...
global w_informe_depreciacion_acumulada_vlr_libros w_informe_depreciacion_acumulada_vlr_libros

type variables

end variables

on w_informe_depreciacion_acumulada_vlr_libros.create
...
on w_informe_depreciacion_acumulada_vlr_libros.destroy
destroy(this.st_6)
destroy(this.st_5)
destroy(this.st_4)
...
event open;m_principal.m_manejodeactivos.m_reportes.m_valorenlibrodelosactivos.Checked = TRUE
...
IF permiso_ventana   = "N" THEN
	...
	CLOSE(w_informe_depreciacion_acumulada_vlr_libros)
	RETURN
END IF
...
event close;m_principal.m_manejodeactivos.m_reportes.m_valorenlibrodelosactivos.Checked = FALSE
end event
...
string text = "Ventana para Generar el Valor en Libro de los Activos de la Compañía."
...
event clicked;CLOSE(w_informe_depreciacion_acumulada_vlr_libros)
end event
...
IF ano.Text = "" OR mes_inicial.Text = "" THEN
...
rta = MessageBox("Mensaje - Validación...","! Desea Calcular el Periodo "+String(ano_periodo,"###,###")+&
			nombre_mes_inicial+" ?",Question!,YesNo!,2)
				
IF rta = 2 THEN RETURN

st_error lst_error
w_segunda.Tag = "! ESPERE POR FAVOR ¡ Ejecutando Procedimiento Almacenado activos_calculo_valor_en_libros... " + string(today(),"dd/mm/yyyy  hh:mm:ss")
w_segunda.SetMicrohelp(w_segunda.Tag)

SetPointer(HourGlass!)

lst_error = fx_activos_calculo_valor_en_libros(ano_periodo, mes_cierre_inicial)
w_informe_depreciacion_acumulada_vlr_libros.Pointer = "Arrow!"
...
OpenWithParm(w_imprime_valor_en_libros_activos,lst_control_activos)
end event
...
string text = "Informe del Valor en Libros de los Activos"
alignment alignment = center!
boolean focusrectangle = false
end type
