$PBExportHeader$w_imprime_log_control_activos.srw
$PBExportComments$Ventana para la Impresión del Log del Control de Activos
forward
global type w_imprime_log_control_activos from window
end type
type cb_filtrar from commandbutton within w_imprime_log_control_activos
end type
type cb_ordenar from commandbutton within w_imprime_log_control_activos
end type
type cb_limpiar from commandbutton within w_imprime_log_control_activos
end type
type cb_exportar from commandbutton within w_imprime_log_control_activos
end type
type mle_1 from multilineedit within w_imprime_log_control_activos
end type
type st_3 from statictext within w_imprime_log_control_activos
end type
type st_2 from statictext within w_imprime_log_control_activos
end type
type pb_2 from picturebutton within w_imprime_log_control_activos
end type
type pb_1 from picturebutton within w_imprime_log_control_activos
end type
type st_1 from statictext within w_imprime_log_control_activos
end type
type dw_1 from datawindow within w_imprime_log_control_activos
end type
type rr_2 from roundrectangle within w_imprime_log_control_activos
end type
type rr_1 from roundrectangle within w_imprime_log_control_activos
end type
end forward
...
string title = "Imprimir Log del Control de Activos..."
...
global w_imprime_log_control_activos w_imprime_log_control_activos
...
on w_imprime_log_control_activos.create
...
on w_imprime_log_control_activos.destroy
...
nombre_reporte		= "Reporte Log del Control de Activos"
nombre_exportar	= "Historico Log del Control de Activos"
...
dw_hija.SetSort("nombre_tabla A, login A, fecha A, codigo_movimiento A, nombre_columna A")
dw_hija.Sort()
dw_hija.SetRedraw(true)
dw_hija.GroupCalc()
end event
...
string text = "Configure el Tamaño de la Página en 8 1/2 * 13 Pulgadas y en la Posición Horizontal."
...
event clicked;close(w_imprime_log_control_activos)
end event
...
boolean enabled = false
string text = "Impresión Log del Control de Activos"
alignment alignment = center!
boolean focusrectangle = false
end type
...
integer taborder = 10
boolean titlebar = true
string title = "Reporte Log del Control de Activos..."
string dataobject = "dw_impresion_log_control_de_activos"
boolean minbox = true
boolean maxbox = true
