$PBExportHeader$w_imprime_botones.srw
$PBExportComments$Ventana para la Impresión de los Botones
forward
global type w_imprime_botones from window
end type
type cb_4 from commandbutton within w_imprime_botones
end type
type cb_3 from commandbutton within w_imprime_botones
end type
type cb_2 from commandbutton within w_imprime_botones
end type
type cb_1 from commandbutton within w_imprime_botones
end type
type mle_1 from multilineedit within w_imprime_botones
end type
type st_3 from statictext within w_imprime_botones
end type
type st_2 from statictext within w_imprime_botones
end type
type pb_2 from picturebutton within w_imprime_botones
end type
type pb_1 from picturebutton within w_imprime_botones
end type
type st_1 from statictext within w_imprime_botones
end type
type dw_1 from datawindow within w_imprime_botones
end type
type rr_2 from roundrectangle within w_imprime_botones
end type
type rr_1 from roundrectangle within w_imprime_botones
end type
end forward
...
string title = "Imprimir Botones de la Aplicación..."
...
global w_imprime_botones w_imprime_botones
...
DO WHILE condicion = TRUE
	nombre_archivo = gb_directorio_salida+"\Botones de la Aplicacion"
...
event clicked;close(w_imprime_botones)
end event
...
IF lst_impresion.dato = "1" THEN
   ...
   FOR conta = 1 TO lst_impresion.copia
 		trabajo = PrintOpen("Reporte Botones de la Aplicación")
...
boolean enabled = false
string text = "Impresión de los Botones de la Aplicación"
alignment alignment = center!
boolean focusrectangle = false
end type
...
integer taborder = 10
boolean titlebar = true
string title = "Reporte de los Botones de la Aplicación..."
string dataobject = "dw_impresion_botones"
boolean minbox = true
boolean maxbox = true
...
w_estado_impresion.sle_1.text = "Reporte Botones de la Aplicación"
gb_name_impresora = dw_1.Describe("Datawindow.Printer")
