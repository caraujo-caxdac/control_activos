$PBExportHeader$w_imprime_usuarios.srw
$PBExportComments$Ventana para la Impresión de los Usuarios de la Aplicación
forward
global type w_imprime_usuarios from window
end type
type cb_1 from commandbutton within w_imprime_usuarios
end type
type cb_2 from commandbutton within w_imprime_usuarios
end type
type cb_3 from commandbutton within w_imprime_usuarios
end type
type cb_4 from commandbutton within w_imprime_usuarios
end type
type mle_1 from multilineedit within w_imprime_usuarios
end type
type st_3 from statictext within w_imprime_usuarios
end type
type st_2 from statictext within w_imprime_usuarios
end type
type pb_2 from picturebutton within w_imprime_usuarios
end type
type pb_1 from picturebutton within w_imprime_usuarios
end type
type st_1 from statictext within w_imprime_usuarios
end type
type dw_1 from datawindow within w_imprime_usuarios
end type
type rr_2 from roundrectangle within w_imprime_usuarios
end type
type rr_1 from roundrectangle within w_imprime_usuarios
end type
end forward
...
string title = "Imprimir Usuarios de la Aplicación..."
...
global w_imprime_usuarios w_imprime_usuarios
...
DO WHILE condicion = TRUE
	nombre_archivo = gb_directorio_salida+"\Usuarios de la Aplicacion"
...
event clicked;close(w_imprime_usuarios)
end event
...
IF lst_impresion.dato = "1" THEN
   ...
   FOR conta = 1 TO lst_impresion.copia
 		trabajo = PrintOpen("Reporte Usuarios Aplicación")
...
IF lst_impresion.dato = "2" THEN
	...
	//MessageBox("Pagina Actual","Número... "+pagina_actual,StopSign!)
	FOR conta = 1 TO lst_impresion.copia	
		trabajo = PrintOpen("Reporte Usuarios Aplicación")
		PrintDataWindow(trabajo,dw_1)
		PrintClose(trabajo)		
...
IF lst_impresion.dato = "3" THEN
	...
	FOR i = 1 TO array_metidos
		...
		//********************************************************//
		//MessageBox("Cuidado...","Página Inicial... "+pagina_inicial+" Página Final... "+pagina_final,Information!)
	   FOR conta = 1 TO lst_impresion.copia
 			trabajo = PrintOpen("Reporte Usuarios Aplicación")
			PrintDataWindow(trabajo,dw_1)
			PrintClose(trabajo)
...
boolean enabled = false
string text = "Impresión de los Usuarios de la Aplicación"
alignment alignment = center!
boolean focusrectangle = false
end type
...
integer taborder = 10
boolean titlebar = true
string title = "Reporte de Usuarios de la Aplicación..."
string dataobject = "dw_impresion_usuarios"
boolean minbox = true
boolean maxbox = true
