$PBExportHeader$w_imprime_permisos_usuarios.srw
$PBExportComments$Ventana para la Impresión de los Permisos de los Usuarios
forward
global type w_imprime_permisos_usuarios from window
end type
type cb_1 from commandbutton within w_imprime_permisos_usuarios
end type
type cb_2 from commandbutton within w_imprime_permisos_usuarios
end type
type cb_3 from commandbutton within w_imprime_permisos_usuarios
end type
type cb_4 from commandbutton within w_imprime_permisos_usuarios
end type
type mle_1 from multilineedit within w_imprime_permisos_usuarios
end type
type st_3 from statictext within w_imprime_permisos_usuarios
end type
type st_2 from statictext within w_imprime_permisos_usuarios
end type
type pb_2 from picturebutton within w_imprime_permisos_usuarios
end type
type pb_1 from picturebutton within w_imprime_permisos_usuarios
end type
type st_1 from statictext within w_imprime_permisos_usuarios
end type
type dw_1 from datawindow within w_imprime_permisos_usuarios
end type
type rr_2 from roundrectangle within w_imprime_permisos_usuarios
end type
type rr_1 from roundrectangle within w_imprime_permisos_usuarios
end type
end forward
...
string title = "Imprimir Permisos Usuarios"
...
global w_imprime_permisos_usuarios w_imprime_permisos_usuarios
...
on w_imprime_permisos_usuarios.create
...
on w_imprime_permisos_usuarios.destroy
destroy(this.cb_1)
destroy(this.cb_2)
destroy(this.cb_3)
destroy(this.cb_4)
...
dw_hija.SetSort("login A, descripcion_menu A, descripcion_botones A")
dw_hija.Sort()
dw_hija.SetRedraw(true)
dw_hija.GroupCalc()
end event
...
DO WHILE condicion = TRUE
	nombre_archivo = gb_directorio_salida+"\Permisos de Usuarios"
...
event clicked;close(w_imprime_permisos_usuarios)
end event
...
IF lst_impresion.dato = "1" THEN
   ...
   FOR conta = 1 TO lst_impresion.copia
 		trabajo = PrintOpen("Reporte Permisos Usuarios")
...
boolean enabled = false
string text = "Impresión de los Permisos de los Usuarios"
alignment alignment = center!
boolean focusrectangle = false
end type
...
integer taborder = 10
boolean titlebar = true
string title = "Reporte Permisos Usuarios..."
string dataobject = "dw_impresion_permisos_usuarios"
boolean minbox = true
boolean maxbox = true
...
w_estado_impresion.sle_1.text = "Reporte Permisos Usuarios"
gb_name_impresora = dw_1.Describe("Datawindow.Printer")
