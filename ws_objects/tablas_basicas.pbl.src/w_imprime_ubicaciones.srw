$PBExportHeader$w_imprime_ubicaciones.srw
$PBExportComments$Ventana para la Impresión de las Marcas o Fabricantes
forward
global type w_imprime_ubicaciones from window
end type
type cb_filtrar from commandbutton within w_imprime_ubicaciones
end type
type cb_ordenar from commandbutton within w_imprime_ubicaciones
end type
type cb_limpiar from commandbutton within w_imprime_ubicaciones
end type
type cb_exportar from commandbutton within w_imprime_ubicaciones
end type
type mle_1 from multilineedit within w_imprime_ubicaciones
end type
type st_3 from statictext within w_imprime_ubicaciones
end type
type st_2 from statictext within w_imprime_ubicaciones
end type
type pb_2 from picturebutton within w_imprime_ubicaciones
end type
type pb_1 from picturebutton within w_imprime_ubicaciones
end type
type st_1 from statictext within w_imprime_ubicaciones
end type
type dw_1 from datawindow within w_imprime_ubicaciones
end type
type rr_2 from roundrectangle within w_imprime_ubicaciones
end type
type rr_1 from roundrectangle within w_imprime_ubicaciones
end type
end forward
...
global w_imprime_ubicaciones w_imprime_ubicaciones
...
on w_imprime_ubicaciones.create
...
on w_imprime_ubicaciones.destroy
...
dw_hija.SetSort("codigo_ubicacion A")
dw_hija.Sort()
dw_hija.SetRedraw(true)
dw_hija.GroupCalc()
end event
...
long backcolor = 16777215
boolean enabled = false
string text = "Impresión de las Ubicaciones"
alignment alignment = center!
boolean focusrectangle = false
end type
...
string dataobject = "dw_impresion_ubicaciones"
boolean minbox = true
boolean maxbox = true
