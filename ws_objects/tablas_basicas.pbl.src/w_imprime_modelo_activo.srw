$PBExportHeader$w_imprime_modelo_activo.srw
$PBExportComments$Ventana para la Impresión de los Módelos de Activos
forward
global type w_imprime_modelo_activo from window
end type
type cb_filtrar from commandbutton within w_imprime_modelo_activo
end type
type cb_ordenar from commandbutton within w_imprime_modelo_activo
end type
type cb_limpiar from commandbutton within w_imprime_modelo_activo
end type
type cb_exportar from commandbutton within w_imprime_modelo_activo
end type
type mle_1 from multilineedit within w_imprime_modelo_activo
end type
type st_3 from statictext within w_imprime_modelo_activo
end type
type st_2 from statictext within w_imprime_modelo_activo
end type
type pb_2 from picturebutton within w_imprime_modelo_activo
end type
type pb_1 from picturebutton within w_imprime_modelo_activo
end type
type st_1 from statictext within w_imprime_modelo_activo
end type
type dw_1 from datawindow within w_imprime_modelo_activo
end type
type rr_2 from roundrectangle within w_imprime_modelo_activo
end type
type rr_1 from roundrectangle within w_imprime_modelo_activo
end type
end forward
...
string title = "Imprimir Módelos de Activos..."
...
global w_imprime_modelo_activo w_imprime_modelo_activo
...
on w_imprime_modelo_activo.create
...
on w_imprime_modelo_activo.destroy
...
nombre_reporte		= "Reporte Modelos de Activos"
nombre_exportar	= "Modelos de Activos"
...
dw_hija.SetSort("descripcion_tipo_inventario A, descripcion_clase_activo A, descripcion_marca A, codigo_marca A")
dw_hija.Sort()
dw_hija.SetRedraw(true)
dw_hija.GroupCalc()
end event
...
string text = "Configure el Tamaño de la Página en 8 1/2 * 11 Pulgadas y en la Posición Horizontal."
...
event clicked;close(w_imprime_modelo_activo)
end event
...
boolean enabled = false
string text = "Impresión de los Módelos de Activos"
alignment alignment = center!
boolean focusrectangle = false
end type
...
integer taborder = 10
boolean titlebar = true
string title = "Reporte de Módelos de Activos..."
string dataobject = "dw_impresion_modelo_activo"
boolean minbox = true
boolean maxbox = true
