$PBExportHeader$w_informacion_adicional_para_activos.srw
$PBExportComments$Ventana para Definir la Información Adicional para los Tipos de Activos
forward
global type w_informacion_adicional_para_activos from window
end type
type mle_1 from multilineedit within w_informacion_adicional_para_activos
end type
type st_2 from statictext within w_informacion_adicional_para_activos
end type
type imprimir from picturebutton within w_informacion_adicional_para_activos
end type
type st_1 from statictext within w_informacion_adicional_para_activos
end type
type st_6 from statictext within w_informacion_adicional_para_activos
end type
type limpiar from picturebutton within w_informacion_adicional_para_activos
end type
type st_5 from statictext within w_informacion_adicional_para_activos
end type
type salir from picturebutton within w_informacion_adicional_para_activos
end type
type st_9 from statictext within w_informacion_adicional_para_activos
end type
type st_8 from statictext within w_informacion_adicional_para_activos
end type
type st_7 from statictext within w_informacion_adicional_para_activos
end type
type eliminar from picturebutton within w_informacion_adicional_para_activos
end type
type grabar from picturebutton within w_informacion_adicional_para_activos
end type
type insertar from picturebutton within w_informacion_adicional_para_activos
end type
type dw_1 from datawindow within w_informacion_adicional_para_activos
end type
type rr_2 from roundrectangle within w_informacion_adicional_para_activos
end type
type rr_1 from roundrectangle within w_informacion_adicional_para_activos
end type
type rr_3 from roundrectangle within w_informacion_adicional_para_activos
end type
end forward
...
string title = "Información Adicional para los Tipos de Activos..."
...
global w_informacion_adicional_para_activos w_informacion_adicional_para_activos
...
on w_informacion_adicional_para_activos.create
...
on w_informacion_adicional_para_activos.destroy
destroy(this.mle_1)
destroy(this.st_2)
...
event open;m_principal.m_tablasbásicas.m_informaciónadicionaldeactivos.Checked = TRUE
...
IF permiso_ventana   = "N" THEN
	...
	CLOSE(w_informacion_adicional_para_activos)
	RETURN
END IF
...
event close;m_principal.m_tablasbásicas.m_informaciónadicionaldeactivos.Checked = FALSE
end event
...
string text = "Ventana para la Definición de la Información Adicional de los Tipos de Activos."
...
event clicked;IF dw_1.RowCount() < 1 THEN
	...
	RETURN
END IF	
w_segunda.Tag = "Generando Reporte de la Información Adicional para Activos... "+"      Fecha del Sistema... " + string(today(),"dd/mm/yyyy  hh:mm:ss")
w_segunda.SetMicrohelp(w_segunda.Tag)
Open(w_imprime_informacion_adicional_de_activos)
end event
...
boolean enabled = false
string text = "Información Adicional para los Tipos de Activos"
alignment alignment = center!
boolean focusrectangle = false
end type
...
event clicked;IF dw_1.ModifiedCount() + dw_1.DeletedCount() > 0 THEN
	...
	//**************************************************//
	String codigo_informacion_adicional, descripcion_informacion_adicional, activo_si_no
	//*****************************************************************//
	...
	codigo_informacion_adicional			= dw_1.GetItemString(fila,"codigo_informacion_adicional")
	descripcion_informacion_adicional	= dw_1.GetItemString(fila,"descripcion_informacion_adicional")
	...
	//*********************************************************//
	dw_1.SetItem(fila,1,codigo_informacion_adicional)
	dw_1.SetItem(fila,2,descripcion_informacion_adicional)
...
Long cuenta_filas
//************************************************************************//
//*** BUSCA EN LA TABLA DE activos_clase_de_activos PARA VER SI EXISTE ***//
//************************************************************************//
//SELECT COUNT(*) INTO :cuenta_filas FROM activos_clase_de_activos WHERE codigo_informacion_adicional = :codigo_informacion_adicional;
//
//IF cuenta_filas > 0 THEN
//	MessageBox("Mensaje - Validación...","! YA Existen Clases de Activos Asociados a este Tipo de Inventario ¡",StopSign!)
//	RETURN
//END IF	
//************************************************************************//
Integer  net
net = MessageBox("Mensaje - Validación...","¿ Está Seguro de Eliminar... "+descripcion_informacion_adicional+" ("+codigo_informacion_adicional+")"+" ?",Question!,YesNo!,2)
...
integer height = 852
integer taborder = 10
string dataobject = "dw_informacion_adicional_para_activos"
