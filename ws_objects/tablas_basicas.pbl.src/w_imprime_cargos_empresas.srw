$PBExportHeader$w_imprime_cargos_empresas.srw
$PBExportComments$Ventana para la Impresión de los Cargos de Empresas
forward
global type w_imprime_cargos_empresas from window
end type
type cb_filtrar from commandbutton within w_imprime_cargos_empresas
end type
type cb_ordenar from commandbutton within w_imprime_cargos_empresas
end type
type cb_limpiar from commandbutton within w_imprime_cargos_empresas
end type
type cb_exportar from commandbutton within w_imprime_cargos_empresas
end type
type mle_1 from multilineedit within w_imprime_cargos_empresas
end type
type st_3 from statictext within w_imprime_cargos_empresas
end type
type st_2 from statictext within w_imprime_cargos_empresas
end type
type pb_2 from picturebutton within w_imprime_cargos_empresas
end type
type pb_1 from picturebutton within w_imprime_cargos_empresas
end type
type st_1 from statictext within w_imprime_cargos_empresas
end type
type dw_1 from datawindow within w_imprime_cargos_empresas
end type
type rr_2 from roundrectangle within w_imprime_cargos_empresas
end type
type rr_1 from roundrectangle within w_imprime_cargos_empresas
end type
end forward
...
string title = "Imprimir Cargos Empresas..."
...
global w_imprime_cargos_empresas w_imprime_cargos_empresas
...
on w_imprime_cargos_empresas.create
...
on w_imprime_cargos_empresas.destroy
...
nombre_reporte		= "Reporte Cargos de Empresa"
nombre_exportar	= "Cargos de Empresa"
...
event clicked;close(w_imprime_cargos_empresas)
end event
...
boolean enabled = false
string text = "Impresión de los Cargos de Empresas Definidos"
alignment alignment = center!
boolean focusrectangle = false
end type
...
integer taborder = 10
boolean titlebar = true
string title = "Reporte de Cargos de Empresas..."
string dataobject = "dw_impresion_cargos_empresa"
boolean minbox = true
boolean maxbox = true
