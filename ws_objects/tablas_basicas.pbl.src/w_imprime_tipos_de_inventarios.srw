$PBExportHeader$w_imprime_tipos_de_inventarios.srw
$PBExportComments$Ventana para la Impresión de los Tipos de Inventarios Definidos
forward
global type w_imprime_tipos_de_inventarios from window
end type
type cb_filtrar from commandbutton within w_imprime_tipos_de_inventarios
end type
type cb_ordenar from commandbutton within w_imprime_tipos_de_inventarios
end type
type cb_limpiar from commandbutton within w_imprime_tipos_de_inventarios
end type
type cb_exportar from commandbutton within w_imprime_tipos_de_inventarios
end type
type mle_1 from multilineedit within w_imprime_tipos_de_inventarios
end type
type st_3 from statictext within w_imprime_tipos_de_inventarios
end type
type st_2 from statictext within w_imprime_tipos_de_inventarios
end type
type pb_2 from picturebutton within w_imprime_tipos_de_inventarios
end type
type pb_1 from picturebutton within w_imprime_tipos_de_inventarios
end type
type st_1 from statictext within w_imprime_tipos_de_inventarios
end type
type dw_1 from datawindow within w_imprime_tipos_de_inventarios
end type
type rr_2 from roundrectangle within w_imprime_tipos_de_inventarios
end type
type rr_1 from roundrectangle within w_imprime_tipos_de_inventarios
end type
end forward
...
string title = "Imprimir Tipos de Inventarios..."
...
global w_imprime_tipos_de_inventarios w_imprime_tipos_de_inventarios
...
on w_imprime_tipos_de_inventarios.create
...
on w_imprime_tipos_de_inventarios.destroy
...
nombre_reporte		= "Reporte Tipos de Inventarios"
nombre_exportar	= "Tipos de Inventarios"
...
dw_hija.SetSort("codigo_tipo_inventario A")
dw_hija.Sort()
dw_hija.SetRedraw(true)
dw_hija.GroupCalc()
end event
...
event clicked;close(w_imprime_tipos_de_inventarios)
end event
...
long backcolor = 16777215
boolean enabled = false
string text = "Impresión de los Tipos de Inventarios"
alignment alignment = center!
boolean focusrectangle = false
end type
...
integer taborder = 10
boolean titlebar = true
string title = "Reporte de los Tipos de Inventarios..."
string dataobject = "dw_impresion_tipos_de_inventarios"
boolean minbox = true
boolean maxbox = true
