$PBExportHeader$w_imprime_marcas_fabricantes.srw
$PBExportComments$Ventana para la Impresión de las Marcas o Fabricantes
forward
global type w_imprime_marcas_fabricantes from window
end type
type cb_filtrar from commandbutton within w_imprime_marcas_fabricantes
end type
type cb_ordenar from commandbutton within w_imprime_marcas_fabricantes
end type
type cb_limpiar from commandbutton within w_imprime_marcas_fabricantes
end type
type cb_exportar from commandbutton within w_imprime_marcas_fabricantes
end type
type mle_1 from multilineedit within w_imprime_marcas_fabricantes
end type
type st_3 from statictext within w_imprime_marcas_fabricantes
end type
type st_2 from statictext within w_imprime_marcas_fabricantes
end type
type pb_2 from picturebutton within w_imprime_marcas_fabricantes
end type
type pb_1 from picturebutton within w_imprime_marcas_fabricantes
end type
type st_1 from statictext within w_imprime_marcas_fabricantes
end type
type dw_1 from datawindow within w_imprime_marcas_fabricantes
end type
type rr_2 from roundrectangle within w_imprime_marcas_fabricantes
end type
type rr_1 from roundrectangle within w_imprime_marcas_fabricantes
end type
end forward
...
string title = "Imprimir Marcas o Fabricantes..."
...
global w_imprime_marcas_fabricantes w_imprime_marcas_fabricantes
...
on w_imprime_marcas_fabricantes.create
...
on w_imprime_marcas_fabricantes.destroy
...
nombre_reporte		= "Reporte Fabricantes"
nombre_exportar	= "Tipos de Fabricantes"
...
dw_hija.SetSort("codigo_marca A")
dw_hija.Sort()
dw_hija.SetRedraw(true)
dw_hija.GroupCalc()
end event
...
event clicked;close(w_imprime_marcas_fabricantes)
end event
...
long backcolor = 16777215
boolean enabled = false
string text = "Impresión de las Marcas o Fabricantes"
alignment alignment = center!
boolean focusrectangle = false
end type
...
integer taborder = 10
boolean titlebar = true
string title = "Reporte de Marcas o Fabricantes..."
string dataobject = "dw_impresion_marcas_fabricantes"
boolean minbox = true
boolean maxbox = true
