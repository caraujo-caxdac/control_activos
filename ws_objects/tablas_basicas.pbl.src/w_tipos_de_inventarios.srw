$PBExportHeader$w_tipos_de_inventarios.srw
$PBExportComments$Ventana para Definir los Tipos de Inventarios que se manejaran en la Entidad
forward
global type w_tipos_de_inventarios from window
end type
type mle_1 from multilineedit within w_tipos_de_inventarios
end type
type st_2 from statictext within w_tipos_de_inventarios
end type
type imprimir from picturebutton within w_tipos_de_inventarios
end type
type st_1 from statictext within w_tipos_de_inventarios
end type
type st_6 from statictext within w_tipos_de_inventarios
end type
type limpiar from picturebutton within w_tipos_de_inventarios
end type
type st_5 from statictext within w_tipos_de_inventarios
end type
type salir from picturebutton within w_tipos_de_inventarios
end type
type st_9 from statictext within w_tipos_de_inventarios
end type
type st_8 from statictext within w_tipos_de_inventarios
end type
type st_7 from statictext within w_tipos_de_inventarios
end type
type eliminar from picturebutton within w_tipos_de_inventarios
end type
type grabar from picturebutton within w_tipos_de_inventarios
end type
type insertar from picturebutton within w_tipos_de_inventarios
end type
type dw_1 from datawindow within w_tipos_de_inventarios
end type
type rr_2 from roundrectangle within w_tipos_de_inventarios
end type
type rr_1 from roundrectangle within w_tipos_de_inventarios
end type
type rr_3 from roundrectangle within w_tipos_de_inventarios
end type
end forward
...
string title = "Tipos de Inventarios..."
...
global w_tipos_de_inventarios w_tipos_de_inventarios
...
on w_tipos_de_inventarios.create
...
on w_tipos_de_inventarios.destroy
destroy(this.mle_1)
destroy(this.st_2)
...
event open;m_principal.m_tablasbásicas.m_tiposdeinventarios.Checked = TRUE
...
event close;m_principal.m_tablasbásicas.m_tiposdeinventarios.Checked = FALSE
end event
...
long backcolor = 16777215
string text = "Ventana para la Definición de los Tipos de Inventarios a Manejar en la Entidad."
...
event clicked;IF dw_1.RowCount() < 1 THEN
	...
	RETURN
END IF	
w_segunda.Tag = "Generando Reporte de los Tipos de Inventarios... "+"      Fecha del Sistema... " + string(today(),"dd/mm/yyyy  hh:mm:ss")
w_segunda.SetMicrohelp(w_segunda.Tag)
Open(w_imprime_tipos_de_inventarios)
end event
...
boolean enabled = false
string text = "Tipos de Inventarios"
alignment alignment = center!
boolean focusrectangle = false
end type
...
event clicked;IF dw_1.ModifiedCount() + dw_1.DeletedCount() > 0 THEN
	...
	//**************************************************//
	String codigo_tipo_inventario, descripcion_tipo_inventario, activo_si_no
	Integer vida_util_anos
	//*****************************************************************//
	...
	codigo_tipo_inventario			= dw_1.GetItemString(fila,"codigo_tipo_inventario")
	descripcion_tipo_inventario	= dw_1.GetItemString(fila,"descripcion_tipo_inventario")
	vida_util_anos						= dw_1.GetItemNumber(fila,"vida_util_anos")	
	activo_si_no						= dw_1.GetItemString(fila,"activo_si_no")
	
	IF IsNull(activo_si_no) THEN activo_si_no = "S"
	IF IsNull(vida_util_anos) THEN vida_util_anos = 0	
	
	//*********************************************************//
	//*** ASIGANCION DE LAS DATOS A LA FILA DEL DATAWINDOWS ***//
	//*********************************************************//
	dw_1.SetItem(fila,1,codigo_tipo_inventario)
	dw_1.SetItem(fila,2,descripcion_tipo_inventario)
	dw_1.SetItem(fila,3,vida_util_anos)
...
//************************************************************************//
SELECT COUNT(*) INTO :cuenta_filas FROM activos_clase_de_activos WHERE codigo_tipo_inventario = :codigo_tipo_inventario;
...
//************************************************************************//
Integer  net
net = MessageBox("Mensaje - Validación...","¿ Está Seguro de Eliminar... "+descripcion_tipo_inventario+" ("+codigo_tipo_inventario+")"+" ?",Question!,YesNo!,2)
...
integer height = 1224
integer taborder = 10
string dataobject = "dw_tipos_de_inventarios"
