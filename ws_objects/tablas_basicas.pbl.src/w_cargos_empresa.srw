$PBExportHeader$w_cargos_empresa.srw
$PBExportComments$Ventana para Definir los Cargos Dfinidos en la Empresa
forward
global type w_cargos_empresa from window
end type
type mle_1 from multilineedit within w_cargos_empresa
end type
type st_2 from statictext within w_cargos_empresa
end type
type imprimir from picturebutton within w_cargos_empresa
end type
type st_1 from statictext within w_cargos_empresa
end type
type st_6 from statictext within w_cargos_empresa
end type
type limpiar from picturebutton within w_cargos_empresa
end type
type st_5 from statictext within w_cargos_empresa
end type
type salir from picturebutton within w_cargos_empresa
end type
type st_9 from statictext within w_cargos_empresa
end type
type st_8 from statictext within w_cargos_empresa
end type
type st_7 from statictext within w_cargos_empresa
end type
type eliminar from picturebutton within w_cargos_empresa
end type
type grabar from picturebutton within w_cargos_empresa
end type
type insertar from picturebutton within w_cargos_empresa
end type
type dw_1 from datawindow within w_cargos_empresa
end type
type rr_2 from roundrectangle within w_cargos_empresa
end type
type rr_1 from roundrectangle within w_cargos_empresa
end type
type rr_3 from roundrectangle within w_cargos_empresa
end type
end forward
...
global w_cargos_empresa w_cargos_empresa
...
event open;m_principal.m_tablasbásicas.m_responsable.m_cargosdefinidosenlaempresa.Checked = TRUE
...
event close;m_principal.m_tablasbásicas.m_responsable.m_cargosdefinidosenlaempresa.Checked = FALSE
end event
...
string text = "Ventana para la Definición de los Cargos de la Empresa."
...
event clicked;IF dw_1.RowCount() < 1 THEN
	...
	RETURN
END IF	
w_segunda.Tag = "Generando Reporte de los Cargos de Empresas... "+"      Fecha del Sistema... " + string(today(),"dd/mm/yyyy  hh:mm:ss")
w_segunda.SetMicrohelp(w_segunda.Tag)
Open(w_imprime_cargos_empresas)
end event
...
boolean enabled = false
string text = "Cargos de la Empresa"
alignment alignment = center!
boolean focusrectangle = false
end type
...
//************************************************************************//
Integer  net
net = MessageBox("Mensaje - Validación...","¿ Está Seguro de Eliminar... "+descripcion_cargo+" ("+codigo_cargo+")"+" ?",Question!,YesNo!,2)
...
integer height = 852
integer taborder = 10
string dataobject = "dw_cargos_empresa"
