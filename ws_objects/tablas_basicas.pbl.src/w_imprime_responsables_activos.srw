$PBExportHeader$w_imprime_responsables_activos.srw
$PBExportComments$Ventana para la Impresión de las Personas Reponsables de los Activos
forward
global type w_imprime_responsables_activos from window
end type
type cb_filtrar from commandbutton within w_imprime_responsables_activos
end type
type cb_ordenar from commandbutton within w_imprime_responsables_activos
end type
type cb_limpiar from commandbutton within w_imprime_responsables_activos
end type
type cb_exportar from commandbutton within w_imprime_responsables_activos
end type
type mle_1 from multilineedit within w_imprime_responsables_activos
end type
type st_3 from statictext within w_imprime_responsables_activos
end type
type st_2 from statictext within w_imprime_responsables_activos
end type
type pb_2 from picturebutton within w_imprime_responsables_activos
end type
type pb_1 from picturebutton within w_imprime_responsables_activos
end type
type st_1 from statictext within w_imprime_responsables_activos
end type
type dw_1 from datawindow within w_imprime_responsables_activos
end type
type rr_2 from roundrectangle within w_imprime_responsables_activos
end type
type rr_1 from roundrectangle within w_imprime_responsables_activos
end type
end forward
...
string title = "Imprimir Responsables de los Activos Fijos..."
...
global w_imprime_responsables_activos w_imprime_responsables_activos
...
on w_imprime_responsables_activos.create
...
on w_imprime_responsables_activos.destroy
...
nombre_reporte		= "Reporte Responsables de los Activos"
nombre_exportar	= "Responsables de los Activos Fijos"
...
dw_hija.SetSort("codigo_cargo A")
dw_hija.Sort()
dw_hija.SetRedraw(true)
dw_hija.GroupCalc()
end event
...
event clicked;close(w_imprime_responsables_activos)
end event
...
boolean enabled = false
string text = "Impresión de los Reponsables de los Activos Fijos"
alignment alignment = center!
boolean focusrectangle = false
end type
...
integer taborder = 10
boolean titlebar = true
string title = "Reporte de los Responsables de los Activos Fijos..."
string dataobject = "dw_impresion_responsables_activos"
boolean minbox = true
boolean maxbox = true
