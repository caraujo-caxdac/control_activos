$PBExportHeader$w_imprime_informacion_adicional_de_activos.srw
$PBExportComments$Ventana para la Impresión de la Información Adicional de los Activos
forward
global type w_imprime_informacion_adicional_de_activos from window
end type
type cb_filtrar from commandbutton within w_imprime_informacion_adicional_de_activos
end type
type cb_ordenar from commandbutton within w_imprime_informacion_adicional_de_activos
end type
type cb_limpiar from commandbutton within w_imprime_informacion_adicional_de_activos
end type
type cb_exportar from commandbutton within w_imprime_informacion_adicional_de_activos
end type
type mle_1 from multilineedit within w_imprime_informacion_adicional_de_activos
end type
type st_3 from statictext within w_imprime_informacion_adicional_de_activos
end type
type st_2 from statictext within w_imprime_informacion_adicional_de_activos
end type
type pb_2 from picturebutton within w_imprime_informacion_adicional_de_activos
end type
type pb_1 from picturebutton within w_imprime_informacion_adicional_de_activos
end type
type st_1 from statictext within w_imprime_informacion_adicional_de_activos
end type
type dw_1 from datawindow within w_imprime_informacion_adicional_de_activos
end type
type rr_2 from roundrectangle within w_imprime_informacion_adicional_de_activos
end type
type rr_1 from roundrectangle within w_imprime_informacion_adicional_de_activos
end type
end forward
...
string title = "Imprimir Información Adicional de Activos..."
...
global w_imprime_informacion_adicional_de_activos w_imprime_informacion_adicional_de_activos
...
on w_imprime_informacion_adicional_de_activos.create
...
on w_imprime_informacion_adicional_de_activos.destroy
...
nombre_reporte		= "Reporte Clases de Activos"
nombre_exportar	= "Clases de Activos"
...
dw_hija.SetSort("descripcion_tipo_inventario A, descripcion_clase_activo A")
dw_hija.Sort()
dw_hija.SetRedraw(true)
dw_hija.GroupCalc()
end event
...
event clicked;close(w_imprime_informacion_adicional_de_activos)
end event
...
boolean enabled = false
string text = "Impresión Información Adicional para los Activos"
alignment alignment = center!
boolean focusrectangle = false
end type
...
integer taborder = 10
boolean titlebar = true
string title = "Reporte Información Adicional de Activos..."
string dataobject = "dw_impresion_clases_de_activos"
boolean minbox = true
boolean maxbox = true
